          ...
          <div className="lg:col-span-2">
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div className="md:col-span-5">
                ...
                <input type="text" name="father_name" id="father_name" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
              </div>
              <div className="md:col-span-5">
                <label for="mother_name">Mother's Name</label>
                <input type="text" name="mother_name" id="mother_name" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
              </div>
              ...
              <div className="md:col-span-5 text-right m-auto mt-5">
